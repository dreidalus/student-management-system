...
<div class="container p-5">
    ...
    <form method="post" action="/courses/store">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="course_information" class="form-control" value="<?= old('course_information') ?>" required>
        </div>

        <div class="mb-3">
            <label class="form-label">Course Description</label>
            <input type="text" name="course_description" class="form-control" value="<?= old('course_description') ?>" required>
        </div>

        <div class="mb-3">
            <label class="form-label">Course College</label>
            <input type="text" name="course_college" class="form-control" value="<?= old('course_college') ?>" required>
        </div>
